...
export type RecipeRuntimeFn<T extends RecipeVariantRecord> =
  RecipeVariantFn<T> & {
...
export type RecipeCompoundSelection<T extends RecipeVariantRecord> = {
  [K in keyof T]?:
    ...
    | Array<StringToBoolean<keyof T[K]>>
}

export type RecipeCompoundVariant<T extends RecipeVariantRecord> =
  RecipeCompoundSelection<T> & {
...
export type SlotRecipeRuntimeFn<
  S extends string,
